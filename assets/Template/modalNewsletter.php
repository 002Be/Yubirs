...
<head>
    ...
    <link href="assets/css/modal_popup.css" rel="stylesheet">
            ...
            <div class="owl-carousel owl-theme categories_carousel">
                ...
                <div class="item_version_2">
                    <a href="gridListingFilterscol.php">
                        <figure>
                            <span>87</span>
                            <img src="assets/img/home_cat_placeholder.jpg" data-src="assets/img/home_cat_sushi.jpg" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Japanese</h3>
                ...
                <div class="item_version_2">
                    <a href="gridListingFilterscol.php">
                        <figure>
                            <span>55</span>
                            <img src="assets/img/home_cat_placeholder.jpg" data-src="assets/img/home_cat_hamburgher.jpg" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Burghers</h3>
                ...
                <div class="item_version_2">
                    <a href="gridListingFilterscol.php">
                        <figure>
                            <span>55</span>
                            <img src="assets/img/home_cat_placeholder.jpg" data-src="assets/img/home_cat_vegetarian.jpg" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Vegetarian</h3>
                                <small>Avg price $40</small>
                            </div>
                ...
                <div class="item_version_2">
                    <a href="gridListingFilterscol.php">
                        <figure>
                            <span>65</span>
                            <img src="assets/img/home_cat_placeholder.jpg" data-src="assets/img/home_cat_bakery.jpg" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Bakery</h3>
                ...
                <div class="item_version_2">
                    <a href="gridListingFilterscol.php">
                        <figure>
                            <span>25</span>
                            <img src="assets/img/home_cat_placeholder.jpg" data-src="assets/img/home_cat_chinesse.jpg" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Chinese</h3>
                                <small>Avg price $40</small>
                            </div>
                ...
                <div class="item_version_2">
                    <a href="gridListingFilterscol.php">
                        <figure>
                            <span>35</span>
                            <img src="assets/img/home_cat_placeholder.jpg" data-src="assets/img/home_cat_mexican.jpg" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Mexican</h3>
    ...
    <div class="popup_content newsletter_c">
        ...
        <div class="row g-0">
            <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center">
                <figure><img src="assets/img/newsletter_img.jpg" alt=""></figure>
            </div>
            <div class="col-md-7">
                <div class="content">
                    <div class="wrapper">
